...
public class Camera {
	 ...
	 * viewPoint = eye point
	 * viewDir = points to the center of the view rectangle
	 * viewUp = points roughly up
	 * projNormal = points in direction of 'w'
	 * viewWidth = distance from left edge to right edge of view rectangle
	 * viewHeight = distance from top to bottom of view rectangle
	 * projDistance = distance to view rectangle from viewPoint
	 */
